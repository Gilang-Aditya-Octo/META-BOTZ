exports.menu = (id, BotName, corohelp, tampilTanggal, tampilWaktu, _panggil_aku_gilang_, 0822-2588-04399, kapanbotaktif, grupch1, grupch2) => {
	return `🔰 -----[ *MENU ${BotName}* ]----- 🔰
...
✅ Follow akun instagram admin ${_panggil_aku_gilang_}
